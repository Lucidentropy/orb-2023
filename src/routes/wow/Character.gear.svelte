                                            ...
                                            <div class="relative z-20 shrink-0 group">
                                                {#if item?.iconUrl}
                                                    <a
                                                        ...
                                                        data-wowhead="item={item.item?.id}&ilvl={item.level?.value ?? ''}"
                                        ...
                                        <div class="w-[180px] text-right leading-tight">
                                            {#if slotMap['MAIN_HAND']}
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    data-wowhead="item={slotMap['MAIN_HAND'].item?.id}&ilvl={slotMap['MAIN_HAND'].level?.value ?? ''}"
                                                    class="mb-0 truncate text-[11px] font-medium"
                                        ...
                                        <div class="w-[180px] text-left leading-tight items-start">
                                            {#if slotMap['OFF_HAND']}
                                                <a
                                                    ...
                                                    target="_blank"
                                                    rel="noopener noreferrer"
                                                    data-wowhead="item={slotMap['OFF_HAND'].item?.id}&ilvl={slotMap['OFF_HAND'].level?.value ?? ''}"
                                                    class="mb-0 truncate text-[11px] font-medium"
